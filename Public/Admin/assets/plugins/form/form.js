...
!function (e) {
    ...
    f.prototype.split_blocks = function (e) {
        ...
        __oneElement__: function (e, t, r) {
            ...
            return a = e.match(/^\s*\[(.*?)\]/), a ? (i += a[0].length, n = {
                ref: (a[1] || String(l)).toLowerCase(),
...
!function (t) {
    ...
    e.prototype = {
        constructor: e, __alterButtons: function (e, n) {
            ...
            var e, n = this, i = this.$ns, a = this.$element, r = (a.css("height"), a.css("width"), this.$editable), s = this.$handler, o = this.$callback, l = this.$options, c = t("<div/>", {
                "class": "md-editor",
                click: function () {
                    n.focus()
                }
            ...
            if (null == this.$editor) {
                ...
                if (l.buttons.length > 0 && (h = this.__buildButtons(l.buttons, h)), l.additionalButtons.length > 0 && (h = this.__buildButtons(l.additionalButtons, h)), c.append(h), a.is("textarea"))a.before(c), e = a, e.addClass("md-input form-control"), c.append(e); else {
                    ...
                    e = t("<textarea/>", {
                        "class": "form-control",
                        val: u
                    }), c.append(e), r.el = a, r.type = a.prop("tagName").toLowerCase(), r.content = a.html(), t(a[0].attributes).each(function () {
            ...
            var e, n = this.$options, i = n.onPreview(this), a = this.$textarea, r = a.next(), s = t("<div/>", {
                "class": "md-preview",
...
!function (t) {
    var i = function () {
        var i = '<div class="colpick"><div class="colpick_color"><div class="colpick_color_overlay1"><div class="colpick_color_overlay2"><div class="colpick_selector_outer"><div class="colpick_selector_inner"></div></div></div></div></div><div class="colpick_hue"><div class="colpick_hue_arrs"><div class="colpick_hue_larr"></div><div class="colpick_hue_rarr"></div></div></div><div class="colpick_new_color"></div><div class="colpick_current_color"></div><div class="colpick_hex_field"><div class="colpick_field_letter">#</div><input type="text" maxlength="6" size="6" /></div><div class="colpick_rgb_r colpick_field"><div class="colpick_field_letter">R</div><input type="text" maxlength="3" size="3" /><div class="colpick_field_arrs"><div class="colpick_field_uarr"></div><div class="colpick_field_darr"></div></div></div><div class="colpick_rgb_g colpick_field"><div class="colpick_field_letter">G</div><input type="text" maxlength="3" size="3" /><div class="colpick_field_arrs"><div class="colpick_field_uarr"></div><div class="colpick_field_darr"></div></div></div><div class="colpick_rgb_b colpick_field"><div class="colpick_field_letter">B</div><input type="text" maxlength="3" size="3" /><div class="colpick_field_arrs"><div class="colpick_field_uarr"></div><div class="colpick_field_darr"></div></div></div><div class="colpick_hsb_h colpick_field"><div class="colpick_field_letter">H</div><input type="text" maxlength="3" size="3" /><div class="colpick_field_arrs"><div class="colpick_field_uarr"></div><div class="colpick_field_darr"></div></div></div><div class="colpick_hsb_s colpick_field"><div class="colpick_field_letter">S</div><input type="text" maxlength="3" size="3" /><div class="colpick_field_arrs"><div class="colpick_field_uarr"></div><div class="colpick_field_darr"></div></div></div><div class="colpick_hsb_b colpick_field"><div class="colpick_field_letter">B</div><input type="text" maxlength="3" size="3" /><div class="colpick_field_arrs"><div class="colpick_field_uarr"></div><div class="colpick_field_darr"></div></div></div><div class="colpick_submit"></div></div>', a = {
            showEvent: "click",
            bornIn: "body",
            onShow: function () {
            },
            ...
            t(a).data("colpick").selector.css("backgroundColor", "#" + d({
                h: i.h,
                s: 100,
                b: 100
            })), t(a).data("colpick").selectorIndic.css({
                left: parseInt(t(a).data("colpick").height * i.s / 100, 10),
                top: parseInt(t(a).data("colpick").height * (100 - i.b) / 100, 10)
            })
        }, p = function (i, a) {
            ...
            this.parentNode.className.indexOf("_hex") > 0 ? (a.data("colpick").color = i = c(L(this.value)), l(i, a.get(0)), r(i, a.get(0))) : this.parentNode.className.indexOf("_hsb") > 0 ? (a.data("colpick").color = i = H({
            ...
            }), l(i, a.get(0)), n(i, a.get(0))) : (a.data("colpick").color = i = e(z({
            ...
            })), n(i, a.get(0)), r(i, a.get(0))), s(i, a.get(0)), p(i, a.get(0)), u(i, a.get(0)), a.data("colpick").onChange.apply(a.parent(), [i, d(i), o(i)])
        }, h = function () {
            ...
            var a = t(this).parent().find("input").focus(), c = {
            ...
            init: function (o) {
                ...
                return this.each(function () {
                    if (!t(this).data("colpickId")) {
                        ...
                        e.find("div.colpick_hue").mousedown(b), a.newColor = e.find("div.colpick_new_color"), a.currentColor = e.find("div.colpick_current_color"), e.data("colpick", a), l(a.color, e.get(0)), r(a.color, e.get(0)), n(a.color, e.get(0)), p(a.color, e.get(0)), s(a.color, e.get(0)), f(a.color, e.get(0)), u(a.color, e.get(0)), a.flat ? (e.appendTo(this).show(), e.addClass("colpick_flat").css({
                            position: "relative",
                            display: "block"
                        })) : (e.appendTo(a.bornIn), t(this).on(a.showEvent, q), e.css({position: "absolute"}))
                    }
                })
            }, showPicker: function () {
                return this.each(function () {
...
!function (t) {
    "use strict";
    var F = [["#000000", "#424242", "#636363", "#9C9C94", "#CEC6CE", "#EFEFEF", "#F7F7F7", "#FFFFFF"], ["#FF0000", "#FF9C00", "#FFFF00", "#00FF00", "#00FFFF", "#0000FF", "#9C00FF", "#FF00FF"], ["#F7C6CE", "#FFE7CE", "#FFEFC6", "#D6EFD6", "#CEDEE7", "#CEE7F7", "#D6D6E7", "#E7D6DE"], ["#E79C9C", "#FFC69C", "#FFE79C", "#B5D6A5", "#A5C6CE", "#9CC6EF", "#B5A5D6", "#D6A5BD"], ["#E76363", "#F7AD6B", "#FFD663", "#94BD7B", "#73A5AD", "#6BADDE", "#8C7BC6", "#C67BA5"], ["#CE0000", "#E79439", "#EFC631", "#6BA54A", "#4A7B8C", "#3984C6", "#634AA5", "#A54A7B"], ["#9C0000", "#B56308", "#BD9400", "#397B21", "#104A5A", "#085294", "#311873", "#731842"], ["#630000", "#7B3900", "#846300", "#295218", "#083139", "#003163", "#21104A", "#4A1031"]], e = function (F, e) {
...
!function (t) {
    ...
    t.fn.extend({
        maxlength: function (e, a) {
            ...
            function d(e) {
                var a = e[0];
                return t.extend({}, "function" == typeof a.getBoundingClientRect ? a.getBoundingClientRect() : {
                    width: a.offsetWidth,
            ...
            var p = t(this), g = {
                alwaysShow: p.data("always-show") || !1,
                bornIn: "body",
                threshold: p.data("threshold") || 10,
                warningClass: "label label-success",
                limitReachedClass: "label label-danger",
                separator: p.data("separator") || " / ",
                preText: p.data("pre-text"),
                postText: p.data("post-text"),
                showMaxLength: !0,
                placement: p.data("position") || "bottom-left",
                showCharsTyped: !0,
                validate: !1,
                utf8: !1
            };
            ...
            return this.each(function () {
                ...
                n.focus(function () {
                    var e = h(a, "0");
                    a = f(n), s = t('<span class="bootstrap-maxlength"></span>').css({
                        display: "none",
                        position: "absolute",
                        whiteSpace: "nowrap",
                        zIndex: 1099
                    }).html(e), n.is("textarea") && (n.data("maxlenghtsizex", n.outerWidth()), n.data("maxlenghtsizey", n.outerHeight()), n.mouseup(function () {
    ...
    e.prototype = {
        constructor: e, init: function () {
            ...
            if (v(), this.options.header && o.css("padding-top", 0), "auto" == this.options.size) {
                var b = function () {
                    var t;
                    v(), e = s - m, n.$newElement.toggleClass("dropup", i > s && e - m < o.height() && n.options.dropupAuto), n.$newElement.hasClass("dropup") && (e = i - m), t = o.find("li").length + o.find("dt").length > 3 ? 3 * d + m - 2 : 0, o.css({
                        "max-height": e + "px",
                        overflow: "hidden",
                        "min-height": t + "px"
                    }), a.css({"max-height": e - h - r - p + "px", "overflow-y": "auto", "min-height": t - p + "px"})
                };
                ...
                e = d * this.options.size + w * c + p, this.$newElement.toggleClass("dropup", i > s && e < o.height() && this.options.dropupAuto), o.css({
                    "max-height": e + h + r + "px",
                    overflow: "hidden"
                }), a.css({"max-height": e - p + "px", "overflow-y": "auto"})
            }
        }, setWidth: function () {
        ...
        header: !1,
        liveSearch: !1
    }, t(document).data("keycount", 0).on("keydown", ".selectpicker[data-toggle=dropdown], .selectpicker[role=menu]", e.prototype.keydown).on("keyup", ".selectpicker[data-toggle=dropdown], .selectpicker[role=menu]", e.prototype.keyup)
}(window.jQuery);
...
+function (e) {
    ...
    i.prototype.listen = function () {
        ...
        if (void 0 === t.target.files && (t.target.files = t.target && t.target.value ? [{name: t.target.value.replace(/^.+\\/, "")}] : []), 0 !== t.target.files.length) {
