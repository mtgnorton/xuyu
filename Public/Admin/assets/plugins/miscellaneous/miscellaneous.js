...
!function (t) {
    var i = {
        ...
        init: function (n, a) {
            return this.each(function () {
                var s = t(this), o = s.data("notific8");
                s.data("notific8", {
                    target: s,
                    settings: {},
                    message: ""
                }), o = s.data("notific8"), o.message = n, t.extend(o.settings, i, a), e._buildNotification(s)
            })
        }, destroy: function (i) {
            i.data("notific8");
            t(window).unbind(".notific8"), i.removeData("notific8")
        }, _buildNotification: function (i) {
            var e = i.data("notific8"), n = t("<div />"), a = Number(t("body").attr("data-notific8s"));
            a++;
            var s = "default" != e.settings.theme ? e.settings.fColor || "#FFF" : "";
            if (n.addClass("jquery-notific8-notification"), n.attr("data-color", e.settings.theme), n.css({
                    "background-color": t.fillColor(n),
                    color: s
                }), n.attr("id", "jquery-notific8-notification-" + a), t("body").attr("data-notific8s", a), e.settings.hasOwnProperty("heading") && "string" == typeof e.settings.heading && n.append(t("<div />").addClass("jquery-notific8-heading").html(e.settings.heading)), e.settings.sticky) {
                var o = t("<div />").addClass("jquery-notific8-close-sticky").append(t("<span />").html("close x"));
                o.click(function () {
                    n.removeClass("in"), setTimeout(function () {
                        n.remove()
                    }, 500)
                }), n.append(o), n.addClass("sticky"), n.find(".jquery-notific8-close-sticky").css({"background-color": t.xcolor.darken(t.fillColor(n), 1, 13)})
            } else {
                var o = t("<div />").addClass("jquery-notific8-close").append(t("<i />").addClass(e.settings.iconClose));
                o.click(function () {
                    n.removeClass("in"), setTimeout(function () {
                        n.remove()
                    }, 500)
            ...
            n.append(t("<div />").addClass("jquery-notific8-message").html(e.message)), t(".jquery-notific8-container." + e.settings.verticalEdge + "." + e.settings.horizontalEdge).append(n), setTimeout(function () {
                n.addClass("in")
            }, 10), e.settings.sticky || !function (t, i) {
                setTimeout(function () {
                    n.removeClass("in"), setTimeout(function () {
                        n.remove()
                    }, 500)
    ...
    t.baseClass = function (i) {
        return i = t(i), i.get(0).className.match(/([^ ]+)/)[1]
    }, t.fn.addDependClass = function (i, e) {
        var n = {delimiter: e ? e : "-"};
        return this.each(function () {
            var e = t.baseClass(this);
            e && t(this).addClass(e + n.delimiter + i)
        })
    }, t.fn.removeDependClass = function (i, e) {
        var n = {delimiter: e ? e : "-"};
        return this.each(function () {
            var e = t.baseClass(this);
            e && t(this).removeClass(e + n.delimiter + i)
        })
    }, t.fn.toggleDependClass = function (i, e) {
        var n = {delimiter: e ? e : "-"};
        return this.each(function () {
            var e = t.baseClass(this);
            e && (t(this).is("." + e + n.delimiter + i) ? t(this).removeClass(e + n.delimiter + i) : t(this).addClass(e + n.delimiter + i))
        })
    }
}(jQuery);
...
!function (e) {
    ...
    function n() {
        ...
        return "requestFullscreen"in e || "mozRequestFullScreen"in e && document.mozFullScreenEnabled || "webkitRequestFullScreen"in e
    }
    ...
    function t(n) {
        e(document).on("fullscreenchange mozfullscreenchange webkitfullscreenchange", function () {
            n(c())
        })
    }

    e.support.fullscreen = n(), e.fn.fullScreen = function (n) {
        if (!e.support.fullscreen || 1 !== this.length)return this;
        if (c())return u(), this;
        var r = e.extend({
            background: "#111",
            callback: e.noop(),
        ...
        }).insertBefore(o).append(o);
        return o.addClass(r.fullscreenClass), l(s.get(0)), s.click(function (e) {
            e.target == this && u()
        }), o.cancel = function () {
            return u(), o
        }, t(function (n) {
            n || (e(document).off("fullscreenchange mozfullscreenchange webkitfullscreenchange"), o.removeClass(r.fullscreenClass).insertBefore(s), s.remove()), r.callback && r.callback(n)
        }), o
    }, e.fn.cancelFullScreen = function () {
        return u(), this
    }
}(jQuery);
...
!function (t, e, s, i) {
    function a(s, i) {
        this.w = t(e), this.el = t(s), this.options = t.extend({}, h, i), this.init()
    }

    var o = "ontouchstart"in e, n = function () {
    ...
    }(), l = o ? "touchstart" : "mousedown", d = o ? "touchmove" : "mousemove", r = o ? "touchend" : "mouseup";
    eCancel = o ? "touchcancel" : "mouseup";
    var h = {
        listNodeName: "ol",
        itemNodeName: "li",
        rootClass: "dd",
    ...
    a.prototype = {
        init: function () {
            ...
            s.reset(), s.el.data("nestable-group", this.options.group), s.placeEl = t('<div class="' + s.options.placeClass + '"/>'), t.each(this.el.find(s.options.itemNodeName), function (e, i) {
                ...
                if (!s.dragEl && (o || 0 === e.button)) {
                    var i = t(e.currentTarget), a = i.data("action"), n = i.parent(s.options.itemNodeName);
                    "collapse" === a && s.collapseItem(n), "expand" === a && s.expandItem(n)
                }
            });
            var i = function (e) {
                var i = t(e.target);
                ...
                !i.length || s.dragEl || !o && 0 !== e.button || o && 1 !== e.touches.length || (e.preventDefault(), s.dragStart(o ? e.touches[0] : e))
            }, a = function (t) {
                s.dragEl && (t.preventDefault(), s.dragMove(o ? t.touches[0] : t))
            }, n = function (t) {
                s.dragEl && (t.preventDefault(), s.dragStop(o ? t.touches[0] : t))
            };
            o ? (s.el[0].addEventListener(l, i, !1), e.addEventListener(d, a, !1), e.addEventListener(r, n, !1), e.addEventListener(eCancel, n, !1)) : (s.el.on(l, i), s.w.on(d, a), s.w.on(r, n))
        }, serialize: function () {
            var e, s = 0, i = this;
            return step = function (e, s) {
                var a = [], o = e.children(i.options.itemNodeName);
                return o.each(function () {
                    var e = t(this), o = t.extend({}, e.data()), n = e.children(i.options.listNodeName);
                    n.length && (o.children = step(n, s + 1)), a.push(o)
                }), a
            ...
            var a = this.mouse, o = t(e.target), n = o.closest(this.options.itemNodeName);
            this.placeEl.css("height", n.height()), a.offsetX = e.offsetX !== i ? e.offsetX : e.pageX - o.offset().left, a.offsetY = e.offsetY !== i ? e.offsetY : e.pageY - o.offset().top, a.startX = a.lastX = e.pageX, a.startY = a.lastY = e.pageY, this.dragRootEl = this.el, this.dragEl = t(s.createElement(this.options.listNodeName)).addClass(this.options.listClass + " " + this.options.dragClass), this.dragEl.css("width", n.width()), n.after(this.placeEl), n[0].parentNode.removeChild(n[0]), n.appendTo(this.dragEl), t(s.body).append(this.dragEl), this.dragEl.css({
                left: e.pageX - a.offsetX,
                top: e.pageY - a.offsetY
            });
            var l, d, r = this.dragEl.find(this.options.itemNodeName);
            for (l = 0; l < r.length; l++)d = t(r[l]).parents(this.options.listNodeName).length, d > this.dragDepth && (this.dragDepth = d)
        }, dragStop: function () {
            ...
            var a, o, l, d, r, h = this.options, p = this.mouse;
            this.dragEl.css({
            ...
            if (!p.moving)return p.dirAx = c, p.moving = !0, void 0;
            p.dirAx !== c ? (p.distAxX = 0, p.distAxY = 0) : (p.distAxX += Math.abs(p.distX), 0 !== p.dirX && p.dirX !== p.lastDirX && (p.distAxX = 0), p.distAxY += Math.abs(p.distY), 0 !== p.dirY && p.dirY !== p.lastDirY && (p.distAxY = 0)), p.dirAx = c, p.dirAx && p.distAxX >= h.threshold && (p.distAxX = 0, l = this.placeEl.prev(h.itemNodeName), p.distX > 0 && l.length && !l.hasClass(h.collapsedClass) && (a = l.find(h.listNodeName).last(), r = this.placeEl.parents(h.listNodeName).length, r + this.dragDepth <= h.maxDepth && (a.length ? (a = l.children(h.listNodeName).last(), a.append(this.placeEl)) : (a = t("<" + h.listNodeName + "/>").addClass(h.listClass), a.append(this.placeEl), l.append(a), this.setParent(l)))), p.distX < 0 && (d = this.placeEl.next(h.itemNodeName), d.length || (o = this.placeEl.parent(), this.placeEl.closest(h.itemNodeName).after(this.placeEl), o.children().length || this.unsetParent(o.parent()))));
            var g = !1;
            if (n || (this.dragEl[0].style.visibility = "hidden"), this.pointEl = t(s.elementFromPoint(i.pageX - s.body.scrollLeft, i.pageY - (e.pageYOffset || s.documentElement.scrollTop))), n || (this.dragEl[0].style.visibility = "visible"), this.pointEl.hasClass(h.handleClass) && (this.pointEl = this.pointEl.parent(h.itemNodeName)), this.pointEl.hasClass(h.emptyClass))g = !0; else if (!this.pointEl.length || !this.pointEl.hasClass(h.itemClass))return;
            var f = this.pointEl.closest("." + h.rootClass), m = this.dragRootEl.data("nestable-id") !== f.data("nestable-id");
            if (!p.dirAx || m || g) {
                if (m && h.group !== f.data("nestable-group"))return;
                if (r = this.dragDepth - 1 + this.pointEl.parents(h.listNodeName).length, r > h.maxDepth)return;
                var u = i.pageY < this.pointEl.offset().top + this.pointEl.height() / 2;
                o = this.placeEl.parent(), g ? (a = t(s.createElement(h.listNodeName)).addClass(h.listClass), a.append(this.placeEl), this.pointEl.replaceWith(a)) : u ? this.pointEl.before(this.placeEl) : this.pointEl.after(this.placeEl), o.children().length || this.unsetParent(o.parent()), this.dragRootEl.find(h.itemNodeName).length || this.dragRootEl.append('<div class="' + h.emptyClass + '"/>'), m && (this.dragRootEl = f, this.hasNewRoot = this.el[0] !== this.dragRootEl[0])
            }
        }
