...
!(function ($) {
    $.fn.capletClock = function (options) {
        ...
        return this.each(function () {
            obj = $(this);
            var analog = $('<div class="cl-analog"/>').append('<svg viewBox="0 0 1000 1000"><path d="m978,498c0,263.98999 -214.01001,478 -478,478s-478,-214.01001 -478,-478s214.00999,-478 478,-478s478,214.00999 478,478zm-952.504,0.00299l23.305,0m899.69998,0l26,0m-474.50198,-474.49999l0,23.305m0,899.7l0,26" class="circle" /><path d="M500,500,500,236" id="hour"/><path d="M500,500,500,120" id="min" /><path d="M500,650,500,90" id="sec" /><circle id="pointSec" cx="50%" cy="50%" r="40" /></svg>').css({
                "width": options.width,
...
!function ($) {
    ...
    var Datetimepicker = function (element, options) {
        ...
        console.log(this.element.data('date-format'));
        console.log(dates[this.language].format);
        console.log();
        console.log();
    ...
    DateRangePicker.prototype = {
        ...
        hide: function (e) {
            ...
            if (this.overlay) {
                ...
                $("body").find('#cl-overlay').fadeOut(400, function () {
                    $(this).remove()
                });
            }
            if (!this.startDate.isSame(this.oldStartDate) || !this.endDate.isSame(this.oldEndDate))
