...
+function (a) {
    ...
    if (!a.fn.tooltip)throw new Error("Popover requires tooltip.js"/*tpa=http://libs.useso.com/js/bootstrap/3.2.0/js/Popover requires tooltip.js*/);
    ...
    function b(b) {
        return this.each(function () {
            var d = a(this), e = d.data("http://libs.useso.com/js/bootstrap/3.2.0/js/bs.tab");
            e || d.data("http://libs.useso.com/js/bootstrap/3.2.0/js/bs.tab", e = new c(this)), "string" == typeof b && e[b]()
        })
    }
    ...
    c.VERSION = "3.2.0", c.prototype.show = function () {
        ...
        if (d || (d = b.attr("href"), d = d && d.replace(/.*(?=#[^\s]*$)/, "")), !b.parent("li").hasClass("active")) {
            var e = c.find(".active:last a")[0], f = a.Event("http://libs.useso.com/js/bootstrap/3.2.0/js/show.bs.tab", {relatedTarget: e});
            if (b.trigger(f), !f.isDefaultPrevented()) {
                var g = a(d);
                this.activate(b.closest("li"), c), this.activate(g, g.parent(), function () {
                    b.trigger({type: "http://libs.useso.com/js/bootstrap/3.2.0/js/shown.bs.tab", relatedTarget: e})
                })
            }
        }
