...
<meta property="og:image" content="http://pic.yupoo.com/hanapp/EGwgfG29/custom.jpg">
    ...
    <script src="/xuyu/Public/JS/jquery.min.js"></script>
    <script src="/xuyu/Public/JS/jquery.jplayer.min.js"></script>
    <script src="/xuyu/Public/JS/jplayer.playlist.min.js"></script>

    <script src="/xuyu/Public/JS/index.js"></script>



    <script src="/xuyu/Public/STATIC/jquery/jquery-2.1.1.min.js"></script>
    <script src="/xuyu/Public/JS/xuyujs.js"></script>
    <!--<script src="/xuyu/Public/Musicoon/js/player.js" type="text/javascript"></script>-->
...
<script src="/xuyu/Public/index_css_js/bootstrap.min.js" tppabs="http://libs.useso.com/js/bootstrap/3.2.0/js/bootstrap.min.js"></script>
    ...
    <!--<link rel="stylesheet" href="/xuyu/Public/Musicoon/css/style.css">-->
    <link rel="stylesheet" href="/xuyu/Public/css/reset.css">

    <link rel="stylesheet" href="/xuyu/Public/css/style.css" media="screen" type="text/css" />
...
<body id="angOne_view" background="/xuyu/Public/image/b4.jpg"   style="text-align:center;">
<style>
    #logo{
        margin: 0 auto;
        border: 1px
...
<!--<div id="logo"><FONT style="FONT-SIZE: 30pt; FILTER: shadow(color=apar); WIDTH: 100%; COLOR: #320b0f;-->
<!--LINE-HEIGHT:100%; FONT-FAMILY: 汉鼎繁中变" size=2>很多时候我们更需要一副温暖人心的图片和一句动人的文字--by 须臾</FONT></div>-->
<!--<div id="header" >-->
<nav class="navbar-fixed-top" style="" >
    <div class="navbar navbar-inverse" role="navigation">

        <div class="container">
            <div class="navbar-inner"  style=" background:#982e4b">
                ...
                <div class="navbar-header">
                    ...
                    <!--<a href="#"><img src="/xuyu/Public/image/xuyu.gif" /></a>-->
                </div>

                <div class="collapse navbar-collapse" id="navbar-collapse-1" role="navigation" style="text-align:
                center">
                   <div style="font-size: larger ;color:"blue";font: sans-serif, Arial, Verdana, "Trebuchet MS";
                    ">hello</div>

                    <ul class="nav navbar-nav navbar-right">
                        <!--<li>-->
                            <!--<button id="bt1" class="btn btn-success"-->
                                    <!--style="background:#1ab5ff;border-style :none;height:50px;">隐藏播放器</button>-->
                        <!--</li>-->
                        <li>
                            <a
                                    href="if(confirm(%27http://wufazhuce.com/one  \n\nThis file was not retrieved by
                                    Teleport Ultra, because it is addressed on a domain or path outside the boundaries set for its Starting Address.  \n\nDo you want to open it from the server?%27))window.location=%27http://wufazhuce.com/one%27" tppabs="http://wufazhuce.com/one">很多时候我们需要的只是一个温暖的图片和那一段文字</a>
                        </li>
...
<style type="text/css">
    body{margin-bottom:50px;padding-top:70px;overflow-x:hidden;}
    ...
    *{font-family:'微软雅黑';font-size:12px;color:#626262;}
    ...
    #bg{background-image:url(/xuyu/Public//images/content/dotted.png);}
    .container{width:100%;height:100%;margin:auto;}

    /*left*/
    .leftsidebar_box{width:160px;height:auto !important;overflow:visible !important;position:fixed;height:100% !important;background-color:#DBC7A3;}
    .line{height:2px;width:100%;background-image:url(/xuyu/Public//images/left/line_bg.png);background-repeat:repeat-x;}
    .leftsidebar_box dt{padding-left:40px;padding-right:10px;background-repeat:no-repeat;background-position:10px center;color: #f50fd6;font-size:14px;position:relative;line-height:48px;cursor:pointer;}
    .leftsidebar_box dd{background-color:#DBC7A3;padding-left:40px;}
    .leftsidebar_box dd a{color: #f51c28;line-height:20px;}
    .leftsidebar_box dt img{position:absolute;right:10px;top:20px;}
    .system_log dt{background-image:url(/xuyu/Public//images/left/cloud.png)}
    .custom dt{background-image:url(/xuyu/Public//images/left/cloud.png)}
    .channel dt{background-image:url(/xuyu/Public//images/left/cloud.png)}
    .app dt{background-image:url(/xuyu/Public//images/left/cloud.png)}
    .cloud dt{background-image:url(/xuyu/Public//images/left/cloud.png)}
    .syetem_management dt{background-image:url(/xuyu/Public//images/left/cloud.png)}
    .source dt{background-image:url(/xuyu/Public//images/left/cloud.png)}
    .statistics dt{background-image:url(/xuyu/Public//images/left/cloud.png)}
    .leftsidebar_box dl dd:last-child{padding-bottom:10px;
    }
    #n1{
        background: #fbfdff; height:10px; width:20px;
...
<body id="bg" style="">
<div id="n1">
<div class="leftsidebar_box" id="n2"  >
    <div class="line"></div>
    <?php if(is_array($daohang)): foreach($daohang as $k=>$vo): ?><dl class="system_log">
        <dt onClick="changeImage()"><?php echo ($k); ?><img src="/xuyu/Public/images/left/select_xl01.png"></dt>
        <dd class="first_dd"><a href="<?php echo U('index',array('date'=>$k));?>"><?php echo ($vo); ?></a></dd>

    </dl><?php endforeach; endif; ?>
    <dl class="system_log">
        <dt onClick="changeImage()">今天<img src="/xuyu/Public/images/left/select_xl01.png"></dt>
        <dd class="first_dd"><a href="<?php echo U('index',array('date'=>$nowdays));?>"><?php echo ($nowtitle); ?></a></dd>

    </dl>

    <!--<dl class="custom">-->
        <!--<dt onClick="changeImage()">6.13<img src="/xuyu/Public/images/left/select_xl01.png"></dt>-->
    ...
    <!--<dl class="channel">-->
        <!--<dt>6.13<img src="/xuyu/Public/images/left/select_xl01.png"></dt>-->
        <!--<dd class="first_dd"><a href="#"></a></dd>-->



    <!--<dl class="app">-->
        <!--<dt onClick="changeImage()">6.15<img src="/xuyu/Public/images/left/select_xl01.png"></dt>-->
        <!--<dd class="first_dd"><a href="#"></a></dd>-->
        <!--<dd><a href="#"></a></dd>-->


    <!--<dl class="cloud">-->
        <!--<dt>6.16<img src="/xuyu/Public/images/left/select_xl01.png"></dt>-->
        <!--<dd class="first_dd"><a href="#"></a></dd>-->
    <!--</dl>-->
    ...
    <!--<dl class="source">-->
        <!--<dt>6.17<img src="/xuyu/Public/images/left/select_xl01.png"></dt>-->
        <!--<dd class="first_dd"><a href="#"></a></dd>-->

    <!--</dl>-->

    <!--<dl class="statistics">-->
        <!--<dt>6.18<img src="/xuyu/Public/images/left/select_xl01.png"></dt>-->
        <!--<dd class="first_dd"><a href="#"></a></dd>-->
    <!--</dl>-->
...
<script type="text/javascript" src="/xuyu/Public/JS/jquery.js"></script>
<script>
...
<script type="text/javascript">
    $(".leftsidebar_box dt").css({"background-color":"#DBC7A3"});
    $(".leftsidebar_box dt img").attr("src","/xuyu/Public/images/left/select_xl01.png");
    $(function(){
        $(".leftsidebar_box dd").hide();
        $(".leftsidebar_box dt").click(function(){
            $(".leftsidebar_box dt").css({"background-color":"##DBC7A3"})
            $(this).css({"background-color": "#DBC7A3"});
            $(this).parent().find('dd').removeClass("menu_chioce");
            $(".leftsidebar_box dt img").attr("src","/xuyu/Public/images/left/select_xl01.png");
            $(this).parent().find('img').attr("src","/xuyu/Public/images/left/select_xl.png");
            $(".menu_chioce").slideUp();
		...
		<div class="tab-content">
		  	<div class="tab-pane active" id="tab-imagen">
		  		<div class="one-imagen">
		  			<img src="<?php echo ($imagePath); ?>" tppabs="http://pic.yupoo.com/hanapp/EGwgfG29/custom.jpg" alt="">
                </div>
                <div class="one-imagen-footer">
					<div class="one-titulo" style="color:#171a16">
					<?php echo ($author); ?>		</div>
					<div class="one-imagen-leyenda" style="color:#3f96ff">
						<br>
<br>
					</div>
					<div class="clearfix" style="display: none;"></div>
				</div>
                <div class="one-cita-wrapper" id="c1" >
                    <div class="one-cita" id="box">
                        <?php echo ($sentence); ?>
                    </div>

                    <div class="render"></div>
                    <div style="float: right">
                    <p  style="color:#3f96ff"><span style="#1ab5ff"><?php echo ($date); ?></span></p>

</div>
                    <button id="btShowContent" class="btn btn-info"  name="showContent">查看具体内容</button>
                    <!--<div class="one-pubdate">-->
                      <!---->
                    <!--</div>-->
                    <div class="clearfix" style="display: none;"></div>
                </div>
                <div id="hideCon" style="display: none;" class="panel panel-warning">
                    <div class="panel-heading">
                        <h3 class="panel-title"><?php echo ($title); ?></h3>
                    </div>
                    <div class="panel-body" id="content_css">
                      <?php echo ($content); ?>
    ...
    <style type="text/css">
       ...
       height:100px;
            width:840px;
            background-image:url("/xuyu/Public/image/wenzi3.jpg");
        }
#box{
    display: none;
}
...
<!--<div id="footer" >-->
        ...
        <div class="music-player" style="margin-top:10px;">
            ...
            <div class="info">
                ...
                <div class="progress jp-seek-bar" >
                    <span class="jp-play-bar" id=""style="width: 0% padding-top:1px;"></span>
                </div>
            </div>
